...
export function recognizeOpening(played: string[]): { eco: string; ar: string; de: string } | null {
  ...
  if (!best) return null;
  return { eco: best.eco, ar: best.ar, de: best.de };
}
