...
export const METHOD_LABELS: Record<CalculationMethodId, { ar: string; }> = {
  MWL:        { ar: 'رابطة العالم الإسلامي', },
  ISNA:       { ar: 'إسنا (أمريكا الشمالية)', },
  Egyptian:   { ar: 'الهيئة المصرية', },
  UmmAlQura:  { ar: 'أم القرى – السعودية', },
  Karachi:    { ar: 'كراتشي – جنوب آسيا', },
  Tehran:     { ar: 'جامعة طهران', },
  Jafari:     { ar: 'الجعفري (شيعة)', },
  Dubai:      { ar: 'دبي – الإمارات', },
  Kuwait:     { ar: 'الكويت', },
  Qatar:      { ar: 'قطر', },
  Singapore:  { ar: 'مويس – سنغافورة', },
  Kemenag:    { ar: 'الأوقاف – إندونيسيا', },
  JAKIM:      { ar: 'جاكيم – ماليزيا', },
  Turkey:     { ar: 'ديانت – تركيا', },
  UOIF:       { ar: 'الاتحاد الإسلامي – فرنسا', },
  Morocco:    { ar: 'الأوقاف – المغرب', },
  Algerian:   { ar: 'الأوقاف – الجزائر', },
  Tunisia:    { ar: 'الأوقاف – تونس', },
  Jordan:     { ar: 'الأوقاف – الأردن', },
  Russia:     { ar: 'مجلس المفتين – روسيا', },
};
