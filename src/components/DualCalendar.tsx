      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between">
          {expanded ? (
            <button
              ...
              className="w-8 h-8 rounded-full flex items-center justify-center obsidian-btn-secondary active:scale-90 duration-150"
            >
        ...
        {isCurrentMonth && (
          <div className="flex items-center gap-2 mb-2 px-1">
            <div className="relative flex-1 h-[2px] obsidian-progress">
              <motion.div
                className="absolute inset-y-0 left-0 rounded-full"
                style={{ width: `${timeProgress * 100}%`, background: `linear-gradient(90deg, hsl(var(--primary)), hsl(var(--primary) / 0.7))` }}
                layout
          ...
          >
            ...
            {calendarDays.map((day, idx) => (
              ...
              >
                {day.isToday && (
                  <motion.div
                    className="absolute inset-0 rounded-lg obsidian-btn"
                    animate={{
                      boxShadow: [
          ...
          {selectedDay && (() => {
            ...
            return (
              <motion.div
                ...
                className="overflow-hidden"
              >
                <div className="flex items-center justify-between obsidian-inset px-4 py-3">
                  ...
                  <div className={`text-[13px] font-bold px-3 py-1.5 rounded-lg ${
                    diffDays === 0
                      ...
                      : diffDays > 0
                        ...
                        : 'obsidian-inset text-muted-foreground'
                  }`}>
                    {label}
                  </div>
                </div>
