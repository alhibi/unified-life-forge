...
export default function PortalTodayWidgets() {
  return (
    <div className="relative z-10 space-y-4">
      ...
      <section aria-labelledby="portal-prayer-h" className="min-h-[17rem] sm:min-h-[16rem]">
        <h2 id="portal-prayer-h" className="sr-only">أوقات الصلاة وبوصلة القبلة</h2>
        <PrayerTimes />
      </section>

      <section aria-labelledby="portal-weather-h" className="min-h-[7.5rem] sm:min-h-[13rem]">
