...
export const PORTAL_APPS: readonly PortalApp[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { path: '/section/timed-sunnah', label: 'السنن المؤقتة', note: 'المرتبطة بالأوقات', icon: Clock },
      { path: '/section/untimed-sunnah', label: 'السنن غير المؤقتة', note: 'يومية عامة', icon: List },
  ...
  /* ── الجسد ── */
  {
    ...
    links: [
      ...
      { path: '/fitness', label: 'اللياقة البدنية', note: 'تتبع GPS حي وجداول التمارين', icon: Gauge },
  ...
  /* ── العقل ── */
  {
    ...
    caption: 'DER CLUB',
    description: 'مكتبة المواقف الحية والقاموس الشامل لتعلم الألمانية',
    cat: 'mind',
    icon: Languages,
    keywords: 'german club deutsch dictionary wörterbuch ألماني لغة ألمانية قاموس معجم دراسة مواقف قواعد مقهى قطار',
    links: [
      { path: '/german-club', label: 'المواقف اليومية', note: 'رفوف العبارات والمفردات', icon: Languages },
      { path: '/german-club/dictionary', label: 'القاموس الشامل', note: 'معجم ألماني-عربي متكامل', icon: Search },
  ...
  },
  {
    ...
    links: [
      ...
      { path: '/archive/new', label: 'توليد مونوغراف', note: 'بحث جديد لموضوع تختاره', icon: Lightbulb },
  ...
  },
  {
    ...
    links: [
      { path: '/podcasts', label: 'الاستكشاف', note: 'كل البودكاست', icon: Binoculars },
      { path: '/podcasts/library', label: 'مكتبتي', note: 'الاشتراكات والمحفوظ', icon: ListMusic },
      { path: '/podcasts/history', label: 'السجل', note: 'ما استمعت إليه', icon: History },
    ],
  },
  {
    key: 'diwan',
  ...
  },
  {
    ...
    links: [
      { path: '/crypto', label: 'أسعار العملات', note: 'متابعة الأسعار والسيولة الفورية', icon: BarChart3 },
    ],
  },
] as const;
