      ...
      >
        <div className="px-4 py-3 flex items-start justify-between gap-3 border-b border-border/30">
          <div className="flex items-center gap-3 min-w-0">
            <div className="text-hero leading-none shrink-0">{c.flag}</div>
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 flex-wrap">
                <h3 className="text-meta font-bold text-foreground truncate leading-tight">
                  {c.nameAr}
                </h3>
                {c.name === 'Makkah' && (
              ...
              <p className="text-micro text-muted-foreground leading-tight mt-0.5 truncate">
                {c.countryAr}
              </p>
            </div>
          </div>
          <div className="text-end shrink-0">
            <div className="text-lead font-bold tabular-nums text-foreground leading-none">
              {c.info.localClock}
            </div>
            <div
              className="text-micro font-bold mt-1 px-2 py-0.5 rounded-full inline-block"
              style={{
        ...
        <div className="px-4 py-2.5 bg-muted/30 flex items-center justify-between gap-2 border-b border-border/30">
          ...
          <div className="text-mini font-bold tabular-nums text-primary">
            {hh > 0 && `${hh}${'س'} `}
            {mm}
            {'د'}
          </div>
          ...
          {prayerRows.map(({ key, min }) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-micro font-bold tabular-nums text-foreground mt-0.5" dir="ltr">
        ...
        <div className="px-4 py-2.5 border-t border-border/30 flex items-center justify-between gap-3 text-micro">
          <div className="flex items-center gap-1.5 text-muted-foreground min-w-0">
            <Info className="w-3 h-3 shrink-0" />
            <span className="truncate">{METHOD_LABELS[c.method].ar}</span>
            <span
              className="shrink-0 text-micro font-bold px-1.5 py-0.5 rounded-full bg-primary/10 text-primary"
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 pt-4 pb-2" dir={'rtl'}>
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-meta font-bold text-foreground leading-tight">
              {'بوصلة القبلة'}
            </h3>
      ...
      <div className="relative px-3 pb-3">
        ...
        <div className="grid grid-cols-5 gap-1.5 mt-2.5" dir={'rtl'}>
          {(
            ...
            >
              ...
              <span className="text-micro font-bold tabular-nums text-foreground mt-0.5">
                {count}
              </span>
            </button>
          ))}
        ...
        <p
          className="text-micro text-muted-foreground text-center mt-2.5 leading-relaxed px-2"
          dir={'rtl'}
        >
              ...
              >
                ...
                <div className="flex items-center justify-between px-5 pt-[max(env(safe-area-inset-top),1rem)] pb-3 border-b border-border/30">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h2 className="text-meta font-bold text-foreground leading-tight">
                        {'بوصلة القبلة'}
                      </h2>
                      <p className="text-micro text-muted-foreground leading-tight mt-0.5">
                ...
                <div className="flex-1 overflow-y-auto pb-[max(env(safe-area-inset-bottom),1.5rem)]">
                  ...
                  <div className="px-4 pt-3">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full py-2 text-mini rounded-xl bg-card border border-border/40 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 ${'pe-9 ps-3'}`}
                        dir={'rtl'}
                      />
                    </div>
                  </div>
                  ...
                  <div className="px-4 pt-3 space-y-1.5">
                    <p className="text-micro font-semibold text-muted-foreground uppercase tracking-wide px-1 mb-2 flex items-center justify-between">
                    ...
                    {sortedCities.length === 0 ? (
                      <div className="text-center text-mini text-muted-foreground py-6">
                        {'لا توجد نتائج'}
                      </div>
                    ) : (
                      sortedCities.map((c) => {
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-2.5 min-w-0 flex-1">
                              <span className="text-title leading-none shrink-0">{c.flag}</span>
                              <span
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <p
                                  className="text-micro text-muted-foreground tabular-nums leading-tight mt-0.5 flex items-center gap-1.5"
                                  dir="ltr"
                                >
                            ...
                            <span
                              className="text-micro font-bold px-2.5 py-1 rounded-full shrink-0"
                              style={{
                  ...
                  <p className="text-micro text-muted-foreground text-center mt-5 px-6 leading-relaxed">
