...
import { Search, X, Feather, ScrollText } from 'lucide-react';
      ...
      <AnimatePresence>
        {items.length > 0 && (
          <motion.div
            ...
            className="absolute z-30 left-0 right-0 top-full mt-1.5 rounded-2xl bg-card border border-border/50 shadow-lg overflow-hidden"
          >
