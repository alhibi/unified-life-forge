          ...
          >
            ...
            <div className="px-5 pt-1 pb-3 flex items-start gap-3 border-b border-border/30">
              ...
              <button
                onClick={onClose}
                aria-label="إغلاق"
                className="w-8 h-8 rounded-full bg-muted/60 hover:bg-muted flex items-center justify-center shrink-0"
              >
              ...
              {versePreview && (
                <div className="mb-4 p-3 rounded-xl bg-muted/40 border border-border/30">
                  <div className="flex items-start gap-2">
                    <Quote className="w-3.5 h-3.5 text-muted-foreground/70 shrink-0 mt-1" />
                    <p
