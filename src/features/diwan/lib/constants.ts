...
//
// مصدر الحقيقة الوحيد لهذه القوائم. سكريبتات scripts/diwan تستوردها
// عبر relative path (راجع scripts/diwan/types.ts) لتجنّب أيّ drift
// بين الواجهة وعمليات الـ ingest.
