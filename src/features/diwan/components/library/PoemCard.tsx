      ...
      >
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            ...
            <span className="text-[0.75rem] text-[var(--wax)] select-none shrink-0" aria-hidden="true">
              ◆
            </span>
            <div className="min-w-0 flex-1">
              <div className="flex items-baseline gap-2 flex-wrap">
                <h3
                  className="font-bold text-[0.9375rem] text-[#F2E9D8] leading-tight"
                  style={{ fontFamily: "'Amiri', serif" }}
                >
                  {poem.title}
                </h3>
                {showPoet && search.poet_name && (
                  <span className="text-[0.6875rem] text-[var(--wax)] font-tajawal font-medium">
                    {search.poet_name}
                  </span>
                )}
              </div>
              {poem.opening && (
                <p
                  className="text-[0.8125rem] text-[#B8AA8E]/90 leading-relaxed mt-1 line-clamp-1 truncate"
                  style={{ fontFamily: "'Amiri', serif" }}
                >
                  {poem.opening}
                </p>
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            ...
            <div className="hidden sm:flex items-center gap-1.5 text-[0.625rem] font-tajawal">
              {poem.meter && (
            ...
            {poem.verses_count > 0 && (
              <span className="text-[0.75rem] text-[#7E7259] font-tajawal">
                {poem.verses_count} {' '}
