      ...
      <div className="flex items-center gap-6 min-w-max border-b border-[var(--hairline)]">
        {showAll && (
          <button
            ...
            className="relative pb-3 text-meta font-medium transition-all flex items-center gap-1.5 focus:outline-none focus-visible:text-[var(--ink-text)]"
            style={{
          ...
          >
            ...
            {totalPoets > 0 && (
              <span
                className="text-micro px-1.5 py-0.5 rounded-full font-sans transition-all"
                style={{
