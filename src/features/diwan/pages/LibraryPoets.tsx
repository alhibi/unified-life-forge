      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex items-start gap-4 mb-6">
          <div className="mt-1 shrink-0">
            <BackButton fallback="/mihrab" className="w-10 h-10 rounded-full border border-[var(--hairline-strong)] bg-[#1D1811] flex items-center justify-center text-[#B8AA8E] hover:text-[#F2E9D8] hover:border-[#B8AA8E] active:scale-95 transition-motion" />
          </div>
          <div className="flex-1 min-w-0">
            ...
            <h1 className="text-hero font-bold tracking-tight text-[#F2E9D8] leading-tight font-amiri">
              {eraLabel ? `شعراء ${eraLabel}` : 'المكتبة الكبرى'}
            </h1>
            <div className="flex items-center gap-2 mt-1.5 flex-wrap">
              <p className="text-mini text-[#B8AA8E]">
        ...
        {poets.isLoading && page === 0 ? (
          ...
          <div className="text-center py-20 flex flex-col items-center justify-center px-4">
            <span className="font-amiri text-hero text-[var(--wax)] mb-4 animate-pulse select-none">
              ✦
            </span>
            <p className="text-[#B8AA8E] text-meta font-medium leading-relaxed max-w-sm">
              {q
          ...
          <div className="flex flex-col">
            ...
            {showLoadMore && (
              <>
                ...
                <button
                  ...
                  className="w-full mt-4 py-3 rounded-[12px] bg-[#1D1811] border border-[var(--hairline-strong)] text-mini font-semibold text-[#B8AA8E] hover:text-[#F2E9D8] hover:border-[#B8AA8E] active:scale-[0.98] transition disabled:opacity-60 flex items-center justify-center gap-2"
                >
                  {poets.isFetching ? (
            ...
            {reachedEnd && list.length > PAGE && (
              <p className="text-center text-micro text-[#7E7259] font-tajawal pt-6 select-none">
