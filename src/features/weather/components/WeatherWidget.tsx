      ...
      <div className="p-4">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <h3 className="text-[0.9375rem] font-semibold text-foreground truncate">
              {'الطقس الآن'}
            </h3>
            <p className="mt-0.5 text-[0.75rem] text-muted-foreground truncate">{cond}</p>
          </div>
        ...
        <div className="mt-4 flex items-end justify-between gap-3" dir="ltr">
          <span className="text-[3.125rem] font-extralight leading-none tracking-tighter text-foreground tabular-nums">
            {temp}°
          </span>
          <div className="pb-1 text-[0.6875rem] text-muted-foreground tabular-nums text-end">
            <div>{'الإحساس'} <span className="text-foreground/85 font-medium">{apparent}°</span></div>
            <div>H {hi}° · L {lo}°</div>
          </div>
        </div>

        <div className="mt-3 grid grid-cols-2 gap-2 text-[0.6875rem] text-muted-foreground">
