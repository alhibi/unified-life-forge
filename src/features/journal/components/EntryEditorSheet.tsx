      ...
      <DrawerContent dir="rtl" className="max-h-[90vh] bg-background border-t border-border">
        ...
        <div className="mx-auto w-full max-w-lg px-5 pb-8 pt-5 space-y-5 overflow-y-auto">
          ...
          <input
            ...
            maxLength={120}
            className="w-full bg-transparent border-0 border-b border-border/60 pb-2 text-[17px] text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:border-primary/60 transition-colors"
          />
          ...
          <textarea
            ...
            rows={9}
            className="w-full bg-card/40 border border-border rounded-2xl px-4 py-3 text-[16px] leading-relaxed text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:border-primary/50 resize-none transition-colors"
          />
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-card/40 border border-border rounded-xl px-4 py-2.5 text-[15px] text-foreground placeholder:text-muted-foreground/70 focus:outline-none focus:border-primary/50 transition-colors"
            />
          </div>
