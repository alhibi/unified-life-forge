...
export const EXPORT_SOURCES: readonly ExportSource[] = [
  ...
  { table: 'mg_connections', ownerColumn: 'user_id', label: 'روابط الهوامش' },
  { table: 'mg_pinboard', ownerColumn: 'user_id', label: 'لوحة الهوامش' },
  { table: 'mg_conversations', ownerColumn: 'user_id', label: 'محاورات الهوامش' },
  { table: 'mg_messages', ownerColumn: 'user_id', label: 'رسائل الهوامش' },
  { table: 'mg_settings', ownerColumn: 'user_id', label: 'إعدادات الهوامش' },
  ...
  // Time Ledger — only tables that actually exist are listed here; naming a
  // phantom table makes every export report a bogus "skipped" entry.
