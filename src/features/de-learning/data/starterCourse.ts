...
import { STATIC_VOCABULARY } from './expandedVocab';
import { STATIC_SENTENCES } from './expandedSentences';
import { STATIC_PHRASES } from './expandedPhrases';
import { STATIC_EXPRESSIONS } from './expandedExpressions';

export const EXTENDED_VOCABULARY_LIST: VocabularyItem[] = STATIC_VOCABULARY;
export const EXTENDED_SENTENCES_LIST: GermanSentence[] = STATIC_SENTENCES;
export const EXTENDED_PHRASES_LIST: GermanPhrase[] = STATIC_PHRASES;
export const EXTENDED_EXPRESSIONS_LIST: GermanExpression[] = STATIC_EXPRESSIONS;
