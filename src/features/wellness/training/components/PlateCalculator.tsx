      ...
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-hero font-bold tabular-nums leading-none text-foreground" dir="ltr">
            {target} <span className="text-meta text-muted-foreground">kg</span>
          </p>
          <p className="text-micro text-muted-foreground mt-1" dir="ltr">
          ...
          <div className="flex gap-1.5 flex-wrap">
            {BAR_OPTIONS.map((b) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-micro font-semibold transition-colors ${
                  barKg === b.kg
