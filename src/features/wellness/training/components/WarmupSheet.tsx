          ...
          >
            ...
            <div className="px-4 pb-6 space-y-4">
                      ...
                      <li key={i}>
                        ...
                        >
                          ...
                          <div className="flex-1 text-start">
                            <p className={`text-mini font-semibold ${done ? 'line-through text-muted-foreground' : 'text-foreground'}`}>
                              {m.name[lang]}
                            </p>
                            <p className="text-micro text-muted-foreground mt-0.5">{m.cue[lang]}</p>
                          </div>
              ...
              <section className="space-y-2">
                ...
                {sets.length === 0 ? (
                  <p className="text-mini text-muted-foreground p-3 bg-muted/30 rounded-xl text-center">
                    {T.noWarmup[lang]}
                  </p>
                ) : (
                  <ul className="space-y-1.5">
                        ...
                        <li key={i}>
                          ...
                          >
                            ...
                            <div className="flex-1 grid grid-cols-3 gap-2 text-start" dir="ltr">
                              <span className="text-mini font-bold tabular-nums text-foreground">{s.weightKg} kg</span>
                              <span className="text-mini tabular-nums text-foreground/80">× {s.reps}</span>
