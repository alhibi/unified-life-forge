          ...
          return (
            <div key={key} className="flex flex-col items-center gap-1.5">
              ...
              <div className="text-center" dir="ltr">
                <div className="text-meta font-bold tabular-nums leading-none text-foreground">
...
function PortionStepper({
  ...
  return (
    ...
    >
      ...
      <span className="text-micro font-bold tabular-nums px-1 min-w-[1.75rem] text-center" style={{ color: accent }}>
