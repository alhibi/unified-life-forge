  ...
  return (
    <div className="space-y-4" dir={'rtl'}>
      ...
      {activeSession ? (
        <div className="rounded-2xl p-4 bg-primary/5 border border-primary/20 space-y-4">
          <div className="flex items-center justify-between">
            <span className="text-mini font-bold text-primary flex items-center gap-1">
          ...
          <div className="text-center py-2">
            <p className="text-micro text-muted-foreground uppercase font-bold tracking-wider mb-1">
              {T.hoursFasted[lang]}
            </p>
            <h3 className="text-hero font-extrabold text-foreground tabular-nums leading-none">
          ...
          {/* Metabolic feedback */}
          {metabolicPhase && (
            <div className="rounded-xl bg-muted/40 p-3 space-y-2 border border-border/20 text-micro">
              <div className="flex items-center justify-between">
              ...
              <p className="text-muted-foreground leading-relaxed text-micro">
        ...
        <div className="rounded-2xl p-4 bg-card border border-border/40 space-y-4">
          <div className="space-y-1">
            ...
            <p className="text-micro text-muted-foreground">{T.protocol[lang]}</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-1.5">
            {PROTOCOLS.map((proto) => {
              ...
              return (
                ...
                >
                  <p className="text-mini">{proto.name}</p>
                  <p className="text-micro font-normal mt-0.5 opacity-80">
      ...
      <div className="rounded-2xl border border-border/30 bg-card p-3.5 space-y-2">
        ...
        {history.length === 0 ? (
          <p className="text-center py-4 text-mini text-muted-foreground">{T.emptyHistory[lang]}</p>
        ) : (
