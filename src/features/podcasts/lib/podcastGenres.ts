...
export const podcastGenres: PodcastGenre[] = [
  ...
  { key: 'islam', id: 1440, labelKey: 'podcasts.genre.islam', parent: 'religion-and-spirituality' },
  {
    key: 'christianity',
    id: 1439,
    labelKey: 'podcasts.genre.christianity',
    parent: 'religion-and-spirituality',
  },
  {
    key: 'spirituality',
    id: 1444,
    labelKey: 'podcasts.genre.spirituality',
    parent: 'religion-and-spirituality',
  },
  {
    key: 'buddhism',
    id: 1438,
    labelKey: 'podcasts.genre.buddhism',
    parent: 'religion-and-spirituality',
  },
  {
    key: 'judaism',
    id: 1441,
    labelKey: 'podcasts.genre.judaism',
    parent: 'religion-and-spirituality',
  },
  {
    key: 'hinduism',
    id: 1546,
    labelKey: 'podcasts.genre.hinduism',
    parent: 'religion-and-spirituality',
  },
  ...
  { key: 'sports-news', id: 1524, labelKey: 'podcasts.genre.sportsNews', parent: 'news' },
  {
    ...
    id: 1532,
    labelKey: 'podcasts.genre.entertainmentNews',
    parent: 'news',
  },
  ...
  /* ----- Education subgenres ----- */
  {
    ...
    id: 1500,
    labelKey: 'podcasts.genre.selfImprovement',
    parent: 'education',
  },
  { key: 'how-to', id: 1499, labelKey: 'podcasts.genre.howTo', parent: 'education' },
  {
    ...
    id: 1498,
    labelKey: 'podcasts.genre.languageLearning',
    parent: 'education',
  },
  ...
  /* ----- Society & Culture subgenres ----- */
  {
    key: 'documentary',
    id: 1543,
    labelKey: 'podcasts.genre.documentary',
    parent: 'society-and-culture',
  },
  {
    key: 'personal-journals',
    id: 1302,
    labelKey: 'podcasts.genre.personalJournals',
    parent: 'society-and-culture',
  },
  {
    key: 'philosophy',
    id: 1443,
    labelKey: 'podcasts.genre.philosophy',
    parent: 'society-and-culture',
  },
  {
    key: 'places-and-travel',
    id: 1320,
    labelKey: 'podcasts.genre.travel',
    parent: 'society-and-culture',
  },
  {
    key: 'relationships',
    id: 1544,
    labelKey: 'podcasts.genre.relationships',
    parent: 'society-and-culture',
  },
  ...
  /* ----- Health & Fitness subgenres ----- */
  {
    key: 'mental-health',
    id: 1517,
    labelKey: 'podcasts.genre.mentalHealth',
  ...
  { key: 'fitness', id: 1515, labelKey: 'podcasts.genre.fitness', parent: 'health-and-fitness' },
  {
    key: 'nutrition',
    id: 1516,
    labelKey: 'podcasts.genre.nutrition',
    parent: 'health-and-fitness',
  },
  { key: 'medicine', id: 1513, labelKey: 'podcasts.genre.medicine', parent: 'health-and-fitness' },
  {
    ...
    id: 1514,
    labelKey: 'podcasts.genre.alternativeHealth',
    parent: 'health-and-fitness',
  },
  {
    key: 'sexuality',
    id: 1518,
    labelKey: 'podcasts.genre.sexuality',
    parent: 'health-and-fitness',
  },
  ...
  { key: 'careers', id: 1471, labelKey: 'podcasts.genre.careers', parent: 'business' },
  {
    ...
    id: 1472,
    labelKey: 'podcasts.genre.entrepreneurship',
    parent: 'business',
  },
  ...
  { key: 'stand-up', id: 1495, labelKey: 'podcasts.genre.standUp', parent: 'comedy' },
  {
    ...
    id: 1493,
    labelKey: 'podcasts.genre.comedyInterviews',
    parent: 'comedy',
  },
  ...
  { key: 'mathematics', id: 1481, labelKey: 'podcasts.genre.mathematics', parent: 'science' },
  {
    ...
    id: 1482,
    labelKey: 'podcasts.genre.naturalSciences',
    parent: 'science',
  },
  ...
  { key: 'physics', id: 1539, labelKey: 'podcasts.genre.physics', parent: 'science' },
  {
    key: 'social-sciences',
    id: 1540,
    labelKey: 'podcasts.genre.socialSciences',
    parent: 'science',
  },
  ...
  /* ----- History subgenres ----- */
  {
    key: 'natural-history',
    id: 1538,
    labelKey: 'podcasts.genre.naturalHistory',
    parent: 'history',
  },
  ...
  /* ----- Government subgenres ----- */
  {
    key: 'non-profit-gov',
    id: 1476,
    labelKey: 'podcasts.genre.nonProfitGov',
    parent: 'government',
  },
  ...
  /* ----- Music subgenres ----- */
  {
    ...
    id: 1525,
    labelKey: 'podcasts.genre.musicCommentary',
    parent: 'music',
  },
  { key: 'music-history', id: 1526, labelKey: 'podcasts.genre.musicHistory', parent: 'music' },
  {
    ...
    id: 1527,
    labelKey: 'podcasts.genre.musicInterviews',
    parent: 'music',
  },
  ...
  { key: 'film-history', id: 1542, labelKey: 'podcasts.genre.filmHistory', parent: 'tv-and-film' },
  {
    key: 'film-interviews',
    id: 1541,
    labelKey: 'podcasts.genre.filmInterviews',
    parent: 'tv-and-film',
  },
  ...
  { key: 'drama', id: 1485, labelKey: 'podcasts.genre.drama', parent: 'fiction' },
  {
    key: 'science-fiction',
    id: 1486,
    labelKey: 'podcasts.genre.scienceFiction',
    parent: 'fiction',
  },
  ...
  /* ----- Kids & Family subgenres ----- */
  {
    ...
    id: 1521,
    labelKey: 'podcasts.genre.educationKids',
    parent: 'kids-and-family',
  },
  { key: 'parenting', id: 1520, labelKey: 'podcasts.genre.parenting', parent: 'kids-and-family' },
  {
    key: 'pets-and-animals',
    id: 1522,
    labelKey: 'podcasts.genre.petsAndAnimals',
    parent: 'kids-and-family',
  },
  {
    key: 'stories-for-kids',
    id: 1523,
    labelKey: 'podcasts.genre.storiesForKids',
    parent: 'kids-and-family',
  },
  ...
  /* ----- Additional deep categories for power users ----- */
  {
    ...
    id: 1443,
    labelKey: 'podcasts.genre.dailyDevotional',
    parent: 'religion-and-spirituality',
  },
  ...
  { key: 'tech-podcasts', id: 1318, labelKey: 'podcasts.genre.techPodcasts', parent: 'technology' },
  {
    key: 'documentary-sub',
    id: 1543,
    labelKey: 'podcasts.genre.documentarySub',
    parent: 'society-and-culture',
  },
  {
    key: 'sports-commentary',
    id: 1557,
    labelKey: 'podcasts.genre.sportsCommentary',
    parent: 'sports',
  },
