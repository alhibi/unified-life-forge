  ...
  return (
    ...
    >
      <header className="flex items-center gap-2 mb-2">
        {isFreshUnplayed && (
          <span
            className="text-micro font-bold tracking-wider px-1.5 py-0.5 rounded-md"
            style={{
        ...
        {playState.played && (
          <span className="text-micro font-bold tracking-wider px-1.5 py-0.5 rounded-md bg-muted/60 text-muted-foreground inline-flex items-center gap-1">
      ...
      <div className="flex items-start gap-3">
        <div className="flex-1 min-w-0">
          <h3 className="text-meta font-bold text-foreground leading-snug line-clamp-2">
            {episode.title}
          </h3>
          {safeDescription && (
            <div
              className="text-mini text-muted-foreground leading-relaxed mt-1 line-clamp-3 podcast-html"
