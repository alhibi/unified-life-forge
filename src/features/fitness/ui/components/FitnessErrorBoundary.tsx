    ...
    if (this.state.hasError) {
      ...
      return (
        <AppCard className="flex flex-col items-center justify-center p-8 text-center space-y-4">
          ...
          <h3 className="text-lg font-medium">عذراً، حدث خطأ في النظام</h3>
          <p className="text-muted-foreground text-sm max-w-[250px]">تعذر تحميل وحدة اللياقة البدنية. يرجى المحاولة مرة أخرى.</p>
