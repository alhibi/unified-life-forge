  ...
  return (
    <PageShell className="pb-page">
      <div className="flex items-center justify-between py-4">
        <h1 className="text-display font-bold font-cormorant-garamond tracking-wide">اللياقة</h1>
      </div>
      <Section tight>
            ...
            <div className="p-6 flex flex-col items-center justify-center text-center z-base relative">
               {isTracking ? (
                 <>
                   ...
                   <div className="text-hero font-montserrat font-light tabular-nums tracking-tighter mb-2">
                     {((currentActivity?.distance_meters || 0) / 1000).toFixed(2)} <span className="text-lead text-muted-foreground">كم</span>
                   </div>
                   <div className="text-muted-foreground flex gap-4 text-meta mb-8 font-montserrat tabular-nums">
                 ...
                 <>
                   ...
                   <h3 className="text-lead font-medium mb-1">جاهز للانطلاق؟</h3>
                   <p className="text-muted-foreground text-meta mb-6 max-w-[250px]">ابدأ تسجيل مسارك، وحلل سرعتك والسعرات المحروقة.</p>
