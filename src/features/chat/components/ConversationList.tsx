    ...
    >
      ...
      >
        <div className="flex items-center gap-1.5 text-primary">
          ...
          <span className="text-micro font-medium">{leftLabel}</span>
        </div>
      </motion.div>
      <motion.div
      ...
      >
        <div className="flex items-center gap-1.5 text-primary">
          ...
          <span className="text-micro font-medium">{rightLabel}</span>
        </div>
      </motion.div>
              ...
              >
                ...
                {showBadge && !active && (
                  <motion.span
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className="bg-primary text-primary-foreground text-micro font-bold rounded-full min-w-[16px] h-[16px] flex items-center justify-center px-1"
                  >
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-muted-foreground gap-4 px-8">
            ...
            <div className="text-center space-y-1">
              <p className="text-meta font-semibold text-foreground/60">
                {filter === 'archived'
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between gap-2 mt-0.5">
                          <div className={cn(
                            'text-mini truncate leading-relaxed flex items-center gap-1.5 min-w-0',
                          ...
                          <div className="flex items-center gap-1 shrink-0">
                            ...
                            {unread > 0 && (
                              <motion.span
                                ...
                                className={cn(
                                  'text-micro rounded-full min-w-[20px] h-[20px] flex items-center justify-center px-1.5 font-bold',
                                  muted
