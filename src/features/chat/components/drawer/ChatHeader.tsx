        ...
        {chat.selectionMode ? (
          ...
          <>
            ...
            >
              ...
              {totalUnread > 0 && (
                <span className="absolute -top-0.5 -end-0.5 bg-primary text-primary-foreground text-micro font-bold rounded-full min-w-[14px] h-[14px] flex items-center justify-center px-1">
