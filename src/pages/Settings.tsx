            ...
            {showGuide && (
              ...
              >
                <div className="px-4 pb-4 space-y-3">
                  ...
                  {[
                    { icon: Home, color: 'text-amber-500', bg: 'bg-amber-500/10', route: '/?highlight=greeting',
                    ...
                    { icon: Calendar, color: 'text-blue-500', bg: 'bg-blue-500/10', route: '/?highlight=calendar',
                    ...
                    { icon: Moon, color: 'text-indigo-500', bg: 'bg-indigo-500/10', route: '/?highlight=prayer',
                    ...
                    { icon: Music, color: 'text-rose-500', bg: 'bg-rose-500/10', route: '/?highlight=audio',
                    ...
                    { icon: MapPin, color: 'text-orange-500', bg: 'bg-orange-500/10', route: '/?highlight=location',
