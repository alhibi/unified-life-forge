...
import { ChevronRight, ChevronLeft, X, BookOpen, Feather, ScrollText, Copy, Check, ClipboardCopy, Flame, Star, Landmark, Castle, Sparkles, Sun } from 'lucide-react';
...
export default function DiwanPage() {
  ...
  return (
    <div className="min-h-screen bg-background pb-28 px-5 pt-14">
      <SEO title="الديوان — الشعر العربي الكلاسيكي — SmartHub" description="تصفح الشعر العربي عبر العصور الجاهلية، الإسلامية، الأموية، المخضرمة، العباسية والأندلسية بخط أميري أنيق." path="/diwan" />
