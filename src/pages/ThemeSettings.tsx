...
const designModesList = [
  {
    id: 'classic' as const,
    nameAr: 'رونق الأوبسيديان والذهب',
    nameDe: 'Obsidian Classic Gold',
    descAr: 'التوازن البصري الخالد لسمارت هاب بنقاء اللون الأسود الأوبسيدياني الفاخر والذهب المصقول.',
    descDe: 'Zeitlose Eleganz mit luxuriösen Obsidian-Flächen und fein geschliffenen Goldakzenten.',
    icon: Sparkles,
  },
  {
    id: 'md3' as const,
    nameAr: 'ماتيريال ٣ الديناميكي',
    nameDe: 'Material 3 Dynamic',
    descAr: 'فلسفة جوجل الحديثة بتموجات لونية حيوية، زوايا دائرية بالغة النعومة وبطاقات تفاعلية ذكية.',
    descDe: 'Googles innovative Design-Philosophie mit weichen Formen, dynamischen Farben und modernster Tiefe.',
    icon: LayoutGrid,
  },
  {
    id: 'ios' as const,
    nameAr: 'آبل الحداثة المطلقة 2024',
    nameDe: 'iOS Native Ultimate',
    descAr: 'البساطة السلسة مع قوائم منسقة تفيض بالدقة والجمال الطبيعي كالهواء النقي.',
    descDe: 'Hauchdünne Linien, iOS-typische Glasflächen und ultrakompakte, fließende Interaktionskurven.',
    icon: Smartphone,
  },
  {
    id: 'aura' as const,
    nameAr: 'الهالة الحريرية النقية',
    nameDe: 'Pure Silk Aura',
    descAr: 'اندماج مذهل بين البساطة السائلة والثراء البصري بألوان محايدة وغيوم هادئة متلألئة.',
