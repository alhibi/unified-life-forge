  ...
  return (
    <div className="space-y-3">
      ...
      <motion.button
        ...
        className="w-full flex items-center gap-3 p-4 rounded-2xl bg-card border border-border/40 opacity-80 active:scale-[0.98] transition-all duration-150 text-start"
      >
